...
## Constants
CODE_DIRECTORY = 'flask-restplus3'
DOCS_DIRECTORY = 'docs'
...
#
#     from flask-restplus3 import metadata
#
# However, when we do this, we also import `flask-restplus3/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'flask-restplus3_cli = flask-restplus3.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'flask-restplus3_gui = flask-restplus3.gui:entry_point'
        # ]
    }
)
